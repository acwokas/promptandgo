...
const GlobalStructuredData = () => {
  ...
  const organization = {
    ...
    description: "Curated AI prompts that get results. Browse 1,000+ tested prompts, use Scout AI optimization, and access specialized Power Packs for ChatGPT, Claude, and more.",
    ...
    offers: [{
      ...
      description: "Access to 1,000+ curated AI prompts completely free",
      price: "0",
      priceCurrency: "USD",
      category: "AI Tools",
    ...
    hasPart: [
      {
        ...
        name: "Prompt Library",
        url: `${origin}/library`,
        description: "Browse 1,000+ AI prompts by category"
      },
      {
        "@type": "WebPage", 
        name: "Scout AI",
