...
const Terms = () => (
  <>
    ...
    <main className="container py-10">
      <SEO title="Terms & Conditions" description="**prompt**andgo.ai Terms & Conditions (Singapore): usage rules, IP, payments, privacy, liability, and your rights." />
    ...
    <section className="prose prose-neutral max-w-none dark:prose-invert">
      <p>
        Welcome to **prompt**andgo ("we", "our", "us"). These Terms &amp; Conditions ("Terms") govern your use of the
      ...
      <p>**prompt**andgo provides AI-powered tools including but not limited to:</p>
      <ul>
      ...
      <p>All content on the Site, including text, graphics, code, prompts, and designs, is owned by or licensed to **prompt**andgo, unless otherwise stated.</p>
      <ul>
      ...
      <ul>
        ...
        <li>You may see "**prompt**andgo" or an affiliated entity on your payment statements</li>
      ...
      <h2>12.&nbsp;&nbsp;Indemnity</h2>
      <p>You agree to indemnify and hold harmless **prompt**andgo, its officers, employees, and partners from any claims, damages, or expenses arising from your use of the Site, AI tools, or breach of these Terms.</p>
      ...
      <p><strong>IMPORTANT:</strong> We reserve the absolute right to discontinue, suspend, or terminate **prompt**andgo's operations at any time, for any reason, with or without notice. This includes but is not limited to:</p>
      <ul>
      ...
      <p>Lifetime Access purchases ($99.50) provide ongoing access to **prompt**andgo services <strong>for as long as the business operates</strong>. "Lifetime" refers to the operational life of **prompt**andgo, not the user's natural lifetime. In the event of business discontinuation:</p>
      <ul>
