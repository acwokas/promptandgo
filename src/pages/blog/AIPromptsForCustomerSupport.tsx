...
const AIPromptsForCustomerSupport = () => {
  ...
  const heroImage = "/uploads/e141a9a1-b98c-4ba8-9401-2469670c9cca.png"; // hero
  const imageTwo = "/uploads/e645ef3a-9d9a-40e8-9f29-bc98b810fe80.png"; // in-article image
  const imageThree = "/uploads/b9bbcee0-042a-4751-9c30-dfc61fe9a846.png"; // also used as blog index thumbnail
