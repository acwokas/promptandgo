-- Update daily AI sends functions to use Singapore timezone (SGT)

-- Function to get current SGT date
...
-- Updated function to get daily AI sends count using SGT
...
BEGIN
  ...
  -- Get current count for today (SGT)
...
-- Updated function to check and increment daily AI sends using SGT
